...
class ImpliedVolatility:
    ...
    def iterate(
        ...
        if dt <= 0:
            ...
            if abs(option_price - intrinsic) < 1e-12:
                return 0.0
    ...
    @classmethod
    def call_vol(cls, option_price, S, K, t, T, r, q, tolerance=1e-8, max_iter=100):
        return cls.iterate(
            option_price,
            S,
            K,
    ...
    @classmethod
    def put_vol(cls, option_price, S, K, t, T, r, q, tolerance=1e-8, max_iter=100):
        return cls.iterate(
            option_price,
            S,
            K,
